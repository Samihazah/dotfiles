...
"# For taking notes, worldbuilding, python developement and other bullshit

"# Stop pretending to be someone you're not:
set nocompatible        " don't try to be vi
filetype off            " needed for highlight plugins
...
"{{ Syntax Highlighting and Colors }}
    Plug 'rust-lang/rust.vim'                          " Rust language rust highlight
